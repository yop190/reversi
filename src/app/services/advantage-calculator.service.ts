...
const DEFAULT_CONFIG: AdvantageConfig = {
    discDifferenceWeight: 0.70,   // Disc count is the most perceivable metric
    cornerControlWeight: 0.20,
    mobilityWeight: 0.10,
    stabilityWeight: 0.00,
    winningThreshold: 0.15,
    ...
    private getPhaseModifier(phase: GamePhase, discDifference: number): number {
        switch (phase) {
            case GamePhase.Early:
                // Early game: Still respond to disc count for musical feedback
